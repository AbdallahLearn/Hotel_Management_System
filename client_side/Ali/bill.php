...
$sql_s = 'SELECT `booking`.`arrival_date`, `booking`.`departure_date`, `room`.`category`, `room`.`price`, `hotel`.`hotel_name`, `city`.`city_name`
FROM `booking` 
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light shadow-lg" id="box">
            <div class="col-md-50 p-lg-2 mx-auto my-1">
                ...
                <div class="form-group">
                    <button id="check_availability" type="submit"><a href="./payment.php?booking_id=<?php echo $booking_id; ?>">Complete payment</a></button>
                </div>
